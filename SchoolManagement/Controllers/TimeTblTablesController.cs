...
namespace SchoolManagement.Controllers
{
    public class TimeTblTablesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var timeTblTables = db.TimeTblTables.Include(t => t.ClassSubjectTable).Include(t => t.StaffTable).Include(t => t.UserTable).OrderByDescending(o=>o.TimeTableID);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.DaysOfWeek = new SelectList(new List<string>
            {
